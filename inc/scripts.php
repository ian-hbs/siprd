		...
		<!-- JS TOUCH : include this plugin for mobile drag / drop touch events-->
		<!-- script src="<?php echo ASSETS_URL; ?>/js/plugin/encription/md5.js"></script --> 
		...
		<!-- EASY NOTY -->
		<!-- script src="<?php echo ASSETS_URL; ?>/js/plugin/noty/jquery.noty.js"></script>
		<script src="<?php echo ASSETS_URL; ?>/js/plugin/noty/layouts/topRight.js"></script>
		<script src="<?php echo ASSETS_URL; ?>/js/plugin/noty/themes/default.js"></script-->		
		...
		<script src="<?php echo ASSETS_URL; ?>/js/my-scripts/ajax_manipulating.js"></script>

		<script src="<?php echo ASSETS_URL; ?>/js/my-scripts/global_function.js"></script>
